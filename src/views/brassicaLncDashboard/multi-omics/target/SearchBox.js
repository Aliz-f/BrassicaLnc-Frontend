...
MobileSearch.propTypes = {
    ...
    handleAdvanceSearchButton: PropTypes.func
};

// ==============================|| SEARCH INPUT ||============================== //

const SearchBox = ({ handleSubmitSearch, handleResetSearchFields, searchQuerys }) => {
    const theme = useTheme();
                                                    ...
                                                    <Grid container alignItems="center" justifyContent="space-between">
                                                        <Grid item xs>
                                                            <MobileSearch
                                                                ...
                                                                handleAdvanceSearchButton={handleAdvanceSearchButton}
                                                            />
                                                            {showAdvancedSearch && <AdvancedSearch searchQuerys={searchQuerys} />}
                                                        </Grid>
                                                    </Grid>
                                                </Box>
                                            </Card>
                ...
                <OutlineInputStyle
                    ...
                    endAdornment={
                        <InputAdornment position="end">
                            ...
                            <ButtonBase sx={{ borderRadius: '12px', ml: '3px' }} onClick={handleSearchIcon}>
                                <HeaderAvatarStyle variant="rounded">
                                    <IconSearch stroke={1.5} size="1.3rem" />
                                </HeaderAvatarStyle>
                            </ButtonBase>
